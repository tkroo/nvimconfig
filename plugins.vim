...
call minpac#add('Shougo/deoplete.nvim', { 'do': function('DoRemote') })
...
call minpac#add('ternjs/tern_for_vim', { 'do': 'npm install && npm install -g tern' })
call minpac#add('1995eaton/vim-better-javascript-completion')


call minpac#add('junegunn/fzf', { 'dir': '~/.fzf', 'do': './install --no-bash' })
...
call minpac#add('gangleri/vim-diffsaved')
...
" formatting
call minpac#add('mattn/emmet-vim', { 'for': ['html','css'] })
